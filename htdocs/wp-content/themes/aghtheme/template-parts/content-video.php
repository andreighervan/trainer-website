...
<a href="#"><img src="<?php bloginfo('stylesheet_directory');?>/img/blog/getnewposts.jpg" class="margin-r-15"></a>
                    ...
                    <?php the_content();?>
                    <a href="<?php the_permalink();?>" target="_blank" class="pull-right continue">continue reading <i class="fa fa-caret-right" aria-hidden="true"></i></a>
                    <br><br><br>
                    <div class="fb-like" data-href="https://developers.facebook.com/docs/plugins/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
              <br><br><br>
               <div class="date"> <?php the_date('F j, Y');?> #<?php the_category(' ');?></div>
                </div>
